...
//
// Draaien: `node maak-geluidsverslag.mjs` vanuit tests/amsterdam-undead/.
...
// Ticket D0: dit script bouwt zijn eigen CDN-intercept i.p.v. helpers.mjs
// te hergebruiken, en resolvet daarom zelf node_modules en het spelbestand.
// node_modules staat één niveau hoger (tests/), amsterdam-undead.html twee
// niveaus hoger (repo-root) — beide sindsdien anders dan __dirname zelf.
