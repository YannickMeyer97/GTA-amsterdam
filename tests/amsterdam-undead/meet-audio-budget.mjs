...
//
// Draaien: `node meet-audio-budget.mjs` vanuit tests/amsterdam-undead/.
...
// Ticket D0: dit script bouwt zijn eigen CDN-intercept i.p.v. helpers.mjs te
// hergebruiken, en resolvet daarom zelf node_modules (één niveau hoger, in
// tests/) en de repo-root (twee niveaus hoger) voor het spelbestand.
