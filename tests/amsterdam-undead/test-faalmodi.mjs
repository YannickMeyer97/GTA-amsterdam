...
// Ticket D0: dit script doet bewust zijn eigen page.goto() (zie hieronder),
// dus GAME_PATH resolvet zelf naar de repo-root, twee niveaus hoger sinds
// dit bestand naar tests/amsterdam-undead/ verhuisde.
