...
check('obstakels.length blijft 57 (T131-baseline; de dome heeft geen collision)', invariantenTest.obstakels === 57, invariantenTest);
check('interactiePunten.length blijft 13 (Ticket 134: AMSTEL-9 erbij, Ticket 183: deur6Punt eraf)', invariantenTest.interactiePunten === 13, invariantenTest);
