...
check('(f) obstakels.length blijft ongewijzigd tijdens 25 golven (kaartbreed 57, T131-baseline -1 door Ticket 183; geen collision toegevoegd door de etalage-mijlpalen)',
  golfSimulatie.obstakelsVoor === golfSimulatie.obstakelsNa && golfSimulatie.obstakelsNa === 57, golfSimulatie);
