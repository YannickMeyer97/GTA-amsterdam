...
// combat-stress.
check('Winkelmarkeringen groeien niet mee met combat-stress (blijft 15, incl. deur5 + deur6 + De Zelflader + T134 AMSTEL-9 + T158 deel B barricadeversterking)',
  stressTest.winkelMarkeringenLengte === 15, stressTest);
