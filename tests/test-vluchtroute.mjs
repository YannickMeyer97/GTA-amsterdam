...
// Ticket 183: 14 -> 13. deur6Punt is vervallen samen met de deur naar
// kelderoost; de ruimte erachter is nu gewoon open.
check('Bij het laden zijn er precies 13 interactiepunten (incl. deur5Punt, De Zelflader en — Ticket 134 — de AMSTEL-9)',
...
// interactiePunten: 13 basis (incl. deur5Punt, De Zelflader en — Ticket 134
// — de AMSTEL-9; Ticket 183 haalde deur6Punt weg) + de 3 vluchtroute-punten
// allemaal weer weg = 13 — het ontsnappingspunt zelf verschijnt (sinds
// Ticket 55) pas na de aankondigingsduur, dus meteen na de derde pickup is
// het nog 13, niet 14.
check('Na alle drie: teller op 3, HUD toont 3/3 + geldvereiste, interactiePunten blijft op 13 (het ontsnappingspunt verschijnt pas na de T55-aankondiging)',
  ...
  && oppakTest.naAlle.interactiePuntenNa === 13,
  oppakTest.naAlle);
...
// bestaande 13 statische winkels — incl. deur5 + Ticket 134 AMSTEL-9;
// Ticket 183 haalde de deur6-markering weg)
